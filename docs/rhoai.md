...
3) Access the `workbench` named `test-argotlsupdate-feb19-2-notebook`.
...
5) In the terminal, run `cd test-argotlsupdate-feb19-2` to navigate to your sample app's directory.
